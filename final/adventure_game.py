...
while True:
    ...
    while True:
        ...
        if choice == "1":
            ...
            if perry["health"] < 40:
                print("Oh! You were spoted. You lose 15 health points!")
            ...
            perry["attack"] += perry["agility"] + perry["stealth"] + perry["strength"]
            ...
            print("Invalid choice. It must be a number from 1-9.")
